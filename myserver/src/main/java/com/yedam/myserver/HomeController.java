...
public class HomeController {
	...
	@GetMapping("insert")
	public String insert(@ModelAttribute("user") UserVO vo, Model model) {
	...
	public String insertProc(RedirectAttributes ra) {
		...
		ra.addAttribute("keyword", "coffe");
		ra.addFlashAttribute("message", "등록완료."); //한번, 새로고침하면 삭제됨.
		
		return "redirect:list"; //list?page=2&keyword=coffe//
	}
}
